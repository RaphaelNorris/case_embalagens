...
with DAG(
    dag_id="setup_schema_tables",
    start_date=datetime(2025, 1, 1),
    schedule=None,
    catchup=False,
    tags=["oracle","setup","schema"],
    template_searchpath=["/home/adami/airflow/dags/sql/operacao_pp"], 
):
    ...
    [t_clientes, t_itens, t_pedidos, t_facas,
     t_maquina, t_cliches, t_paradas, t_tarefcon, t_fi]
