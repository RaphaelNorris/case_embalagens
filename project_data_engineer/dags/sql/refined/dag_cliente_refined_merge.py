...
def etl_clientes_trusted_to_refined(**context):
    ...
    try:
        ...
        if payload:
            ...
            _process_batch_clientes_refined_merge(payload)
...
def _process_batch_clientes_refined_merge(payload):
    """Processa todos os registros no Oracle REFINED com MERGE"""
    merge_sql = """
        MERGE INTO CLIENTES dest
        USING (
            SELECT 
                :ID_CLIENTE as ID_CLIENTE,
                :TX_CLIENTE as TX_CLIENTE,
                :CD_CLIENTE as CD_CLIENTE,
                :CD_REPRESENTANTE as CD_REPRESENTANTE
            FROM DUAL
        ) src
        ON (dest.ID_CLIENTE = src.ID_CLIENTE)
        WHEN MATCHED THEN
            UPDATE SET 
                TX_CLIENTE = src.TX_CLIENTE,
        ...
        WHEN NOT MATCHED THEN
            INSERT (
                ...
                src.ID_CLIENTE, src.TX_CLIENTE, src.CD_CLIENTE, src.CD_REPRESENTANTE
            )
    """
...
# -----------------
with DAG(
    dag_id="etl_trusted_to_refined_clientes_merge",
